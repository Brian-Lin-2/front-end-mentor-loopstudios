  ...
  return (
    <div className="tracking-wide flex flex-col items-center mb-32">
      <div className="lg:flex lg:justify-between lg:w-3/4 lg:items-center lg:mb-16">
        ...
        <button className="border-2 border-black py-2 px-8 font-alata tracking-super-wide text-xs hidden hover:bg-black hover:text-white lg:block">SEE ALL</button>
      </div>
