export default function Info() {
  return (
    <div className="flex flex-col items-center lg:flex-row lg:items-end lg:p-40">
      ...
      <img className="hidden ml-4 lg:block" src="/images/desktop/image-interactive.jpg" alt="vr"></img>

      <div className="text-center mx-10 mb-28 lg:text-left lg:m-0 lg:absolute lg:bg-white lg:right-24 lg:px-20 lg:pt-24 lg:w-5/12">
        <h1 className="font-josefin-sans text-3xl mb-6 tracking-wide lg:text-5xl">THE LEADER IN INTERACTIVE VR</h1>
        <p className="font-alata text-dark-gray text-15px">
