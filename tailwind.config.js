  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'from-above-desktop': "linear-gradient(to right, hsla(0, 0%, 0%, 50%), hsla(0, 0%, 100%, 0%)), url('/images/desktop/image-from-above.jpg')",
        'grid-desktop': "linear-gradient(to right, hsla(0, 0%, 0%, 50%), hsla(0, 0%, 100%, 0%)), url('/images/desktop/image-grid.jpg')",
        'night-arcade-desktop': "linear-gradient(to right, hsla(0, 0%, 0%, 50%), hsla(0, 0%, 100%, 0%)), url('/images/desktop/image-night-arcade.jpg')",
        'pocket-borealis-desktop': "linear-gradient(to right, hsla(0, 0%, 0%, 50%), hsla(0, 0%, 100%, 0%)), url('/images/desktop/image-pocket-borealis.jpg')",
        'soccer-team-desktop': "linear-gradient(to right, hsla(0, 0%, 0%, 50%), hsla(0, 0%, 100%, 0%)), url('/images/desktop/image-soccer-team.jpg')",
      },
      letterSpacing: {
        'super-wide': '.4em',
      },
